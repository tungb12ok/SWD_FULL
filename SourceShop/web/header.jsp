...
//CartServiceImpl().getCartCount((String) session.getAttribute("username"));
        ...
        <%
        } else if(userType == null) { //ADMIN HEADER
        %>
        ...
        <div class="container-fluid text-center"
            ...
            <form class="form-inline">
                <div class="input-group">
                    <input type="text" id="text-search" class="form-control" size="50" name="search"
                           placeholder="Search Items" required>
                    <div class="input-group-btn">
                        <input type="submit" onclick="searchAdmin()" class="btn btn-danger" value="Search" />
                    </div>
                </div>
            </form>
            <p align="center"
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="myNavbar">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="dropdown"><a class="dropdown-toggle"
                                                data-toggle="dropdown" href="#">Category11 <span class="caret"></span>
                            </a>
                            <ul class="dropdown-menu">
